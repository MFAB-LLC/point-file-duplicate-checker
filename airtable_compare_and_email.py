...
def main():
    ...
    for submission in submissions:
        ...
        if duplicates:
            ...
            result_body = "Duplicates Found:\n\n"
            
            for key, files in duplicates.items():
                result_body += f"{key}: {', '.join(files)}\n"
        else:
...
# Let me know if you’d like any adjustments to the script or if you want help setting up GitHub Actions or Zapier! 🚀
